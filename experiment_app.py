...
UNIVERSAL_PROJECTS = [
    {
        ...
        "detail": "**🎯【核心商业目标】**\n公司拟承接 T 国 100MW 光伏电站 EPC 总包项目，合同金额约 1.2 亿美元。该项目被视为公司进入当地新能源市场的重要样板工程。\n\n**🤝【交易结构与内部意见】**\n商务条件为：业主支付 10% 预付款，剩余 90% 按工程节点支付，存在一定 O/A 账期。业务开发部和工程部认为，该项目有利于公司打开区域市场，但也承认业主回款节奏和当地金融环境需要重点关注。\n\n**⚖️【当前决策】**\n请结合当前页面提供的信息与您的专业判断，决定是否批准该项目进入合同谈判阶段。",
        "raw_data": "▶ **业主背景**：业主为当地较有影响力的能源集团，过往有大型基础设施项目履约记录，但近一年现金流波动加大。\n▶ **财务变化**：业主母公司流动比率由 1.8 下降至 1.1，速动比率约 0.6，显示短期流动性压力上升；但其仍保有政府长期购电协议和部分抵押资产。\n▶ **风险缓释安排**：公司已获得中国信保原则性承保意向，覆盖比例约为合同金额的 80%，但最终赔付需满足报损、单据、履约合规等条件。\n▶ **自担敞口与时间成本**：公司需承担一定比例的自留风险，且信保赔付通常存在调查周期。若材料完整且责任认定清晰，赔付周期可能缩短；但具体周期仍取决于个案审核。",
        "ai_advice": "**【最终建议】** 🛑 高风险 / 建议暂缓推进\n**【系统置信度】** 92.4%\n\n**【Agent 推理链】**\n1. **业主短期偿债压力上升**：业主母公司流动比率和速动比率均明显下降，说明其短期流动性承压，后续工程款支付存在不确定性。\n2. **信保并非即时现金保障**：即使存在信保安排，赔付仍依赖完整报损、责任认定和审核流程，不能等同于即时回款。\n3. **敞口与现金流压力不可忽视**：在大额 EPC 项目中，即使部分损失可被覆盖，自留风险和等待周期也可能对公司现金流形成压力。因此建议暂缓推进，待业主补充付款保障后再进入谈判。",
        "is_faulty": True
    }, 
    {
        "id": "P2", 
        ...
        "title": "中东绿氢项目电解槽采购决策", 
        "detail": "**🎯【核心商业目标】**\n公司拟推进中东绿氢项目投建，需采购 100MW 电解槽系统。该设备采购将直接影响项目初始投资额、交付进度和后续市场认证。\n\n**🤝【供应链替代方案与内部意见】**\n经寻源，欧洲某供应商报价比市场均价低约 35%，且承诺交期提前 2 个月。采购部认为该报价有助于压低 CAPEX，工程部认为其设备性能参数基本满足项目要求。但合规团队提示，供应链碳足迹可能影响项目后续绿色认证和客户接受度。\n\n**⚖️【当前决策】**\n请结合当前页面提供的信息与您的专业判断，决定是否批准该采购合同。",
        "raw_data": "▶ **设备性能**：该供应商为欧洲知名设备厂商，电解槽核心性能测试达标，报价较市场均价低约 35%，交付周期较短。\n▶ **生产端碳足迹**：其主要产线位于东欧某国，电力结构中化石能源占比较高，单位产品制造碳排放强度显著高于部分西欧供应商。\n▶ **政策环境**：欧盟 CBAM 仍处于过渡与细则完善阶段，未来碳成本测算存在不确定性。不同机构对碳价和适用范围的预测差异较大。\n▶ **客户与认证风险**：部分欧洲客户已开始要求供应链披露碳足迹，但不同客户执行强度不一。若未来项目产品进入欧盟或面向欧盟客户，供应链碳强度可能影响绿色认证、投标评分或溢价能力。\n▶ **缓释可能性**：供应商提出可通过购买绿证或签署绿电协议改善披露表现，但相关证书是否被目标市场完全认可仍需进一步确认。",
        "ai_advice": "**【最终建议】** ⚠️ 合规风险较高 / 建议暂缓批准并重新评估供应商方案\n**【系统置信度】** 91.8%\n\n**【Agent 推理链】**\n1. **低价优势可能被长期合规成本侵蚀**：该供应商报价显著低于市场均价，但其生产端碳排放强度较高，未来若项目面向欧盟客户，可能面临额外合规成本或认证压力。\n2. **绿色供应链要求正在强化**：虽然相关政策仍在完善，但下游客户和金融机构对绿氢项目的供应链碳足迹要求正在提高，低碳认证可能影响项目融资、投标和客户接受度。\n3. **缓释方案存在不确定性**：绿证或绿电协议能否被目标市场认可仍不确定，短期 CAPEX 节省未必足以覆盖长期市场准入和品牌风险。因此建议暂缓批准，要求供应商提交可验证的低碳生产或替代方案。",
        "is_faulty": False
    } 
]
